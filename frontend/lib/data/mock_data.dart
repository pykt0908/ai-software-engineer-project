...
/// Decorative / test fixtures only.
/// Do not use as production feed, profile posts, or auth identity fallbacks.
class MockData {
  // Test + decorative identity (FLUTTER_TEST stubs, story peers)
  ...
  /// Stories tray chrome. Self entry is replaced at runtime with the real user.
